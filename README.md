...
3. [Файлы yaml для импорта товаров - 1 шт.](/Netology/data/shop1.yaml)
4. [Пример API Сервиса для магазина](/Netology/reference//netology_pd_diplom/) 
...
Базовая часть:
1. [Создание и настройка проекта](/Netology/reference/step-1.md)
2. [Проработка моделей данных](/Netology/reference/step-2.md)
3. [Реализация импорта товаров](/Netology/reference/step-3.md)
4. [Реализация API views](/Netology/reference/step-4.md)
5. [Полностью готовый backend](/Netology/reference/step-5.md)

Продвинутая часть (по желанию, если базовая часть полностью готова):

6. [Реализация forms и views админки склада](/Netology/reference/step-6-adv.md)
7. [Вынос медленных методов в задачи Celery](/Netology/reference/step-7-adv.md)
...
[перейдите по ссылке](/Netology/reference/step-1.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-2.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-3.md).

### Этап 4. Реализация forms и views

Критерии достижения:

1. Реализованы API Views для основных [страниц](/Netology/reference/screens.md) сервиса (без админки):
   - Вход
   - Регистрация
   - Список товаров
   - Карточка товара
...
Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-4.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-5.md).

## Полезные материалы

1. [Информация о сервисе](/Netology/reference/service.md)
2. [Спецификация API](/Netology/reference/api.md)
3. [Описание страниц сервиса](/Netology/reference/screens.md)
...
1. Реализованы API views для [страниц админки](/Netology/reference/screens.md) сервиса.


Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-6-adv.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](/Netology/reference/step-7-adv.md).  
