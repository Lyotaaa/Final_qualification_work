    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Указывает, должен ли данный пользователь считаться активным.Снимите этот флажок вместо удаления учетных записей.",
                        verbose_name="active",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        verbose_name="Когда был сгенерирован этот токен.",
                    ),
                ),
                (
                    "key",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_rrc",
                    models.PositiveIntegerField(verbose_name="Розничная цена"),
                ),
                (
                    "product",
                    models.ForeignKey(
